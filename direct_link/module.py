"""Главный класс модуля 'Прямая ссылка' (async)."""
...
class DirectLinkModule:
    ...
    # ---------- публичный API для хоста ----------

    async def is_enabled_for(self, bot_id: int) -> bool:
        """Зови из бот-фреймворка перед хендлером /start."""
    ...
    def build_router(self) -> APIRouter:
        ...
        # ===== админские ручки (зовёт UI менеджера) =====
