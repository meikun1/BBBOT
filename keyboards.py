"""
Клавиатуры менеджера ботов.

Главное меню (1-я страница): сверху — список добавленных ботов
(если они есть), снизу — кнопки управления.
"""
...
def main_menu_kb(user_bots: list[dict]) -> InlineKeyboardMarkup:
    ...
    # Сверху — список ботов пользователя (как на скриншоте).
    ...
    # Управление ботами | Создать бота
    builder.row(
