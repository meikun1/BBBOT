"""
========================================================================
 МОДУЛЬ: «⚙️ Создать бота»
------------------------------------------------------------------------
 Принимает токен дочернего бота, проверяет через getMe, сохраняет в БД
 и сразу поднимает его polling в рантайме менеджера.
========================================================================
"""
...
# Формат токена BotFather: 123456789:AaBbCc...
