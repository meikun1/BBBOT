...
========================================================================
 МОДУЛЬ: «📁 Папки ботов»
------------------------------------------------------------------------
 Группировка ботов по папкам: создать папку, открыть её содержимое,
 переложить бота в папку, удалить папку.
========================================================================
"""
...
# ----------------------------------------- переложить бота в папку (из карточки)
