"""
========================================================================
 МОДУЛЬ: «🔥 Защита от бана» (Guard)
------------------------------------------------------------------------
 Как работает: когда защита включена, бот реагирует ТОЛЬКО на переход
 по персональной deep-link ссылке вида
     https://t.me/<bot>?start=<секрет>
 На голый /start (например, от модератора Telegram, который проверяет
 ботов на нарушения) бот молчит — это снижает риск бана.

 Здесь же — переключатель вкл/выкл и персональная ссылка для юзера.
========================================================================
"""
