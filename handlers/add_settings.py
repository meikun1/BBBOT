"""
========================================================================
 МОДУЛЬ: «📨 Настройки добавления»
------------------------------------------------------------------------
 Настройка обработки заявок в канал для конкретного бота:
  • авто-приём заявки (вкл/выкл)
  • приветственное сообщение, которое бот пишет человеку первым
 С главной страницы открывается выбор бота, дальше — карточка настроек.
========================================================================
"""
