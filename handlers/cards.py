"""
Общий рендер карточки бота (страница конкретного бота).

Соответствует скриншотам: шапка с инфо о боте + сетка кнопок-модулей.
Вынесено отдельно, чтобы любой модуль мог вернуть пользователя на
карточку без циклических импортов.
"""
