"""
========================================================================
 МОДУЛЬ: «📈 Статистика» / «🔄 Обновить статистику»
------------------------------------------------------------------------
 Запуски бота: кто и откуда запускал (user_id + гео по языку клиента).
========================================================================
"""
...
from database import get_bot, get_launch_stats, get_recent_launches
