...
------------------------------------------------------------------------
 Держим всё в одном сообщении: /start не плодит новые сообщения, а
 редактирует прежнее главное меню (если оно ещё доступно), команду /start
 при этом удаляем.
========================================================================
"""
...
async def cmd_start(message: Message, state: FSMContext) -> None:
    ...
    # убираем саму команду /start, чтобы чат не рос
